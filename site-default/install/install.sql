...
INSERT INTO `field_title` (pages_id, data) VALUES('1', 'PageName') ON DUPLICATE KEY UPDATE pages_id=VALUES(pages_id), data=VALUES(data);
...
INSERT INTO `field_title` (pages_id, data) VALUES('1007', 'Delete Page') ON DUPLICATE KEY UPDATE pages_id=VALUES(pages_id), data=VALUES(data);
...
INSERT INTO `modules` (id, class, flags, data) VALUES('149', 'AdminThemeDefault', '2', '{\"colors\":\"classic\"}') ON DUPLICATE KEY UPDATE id=VALUES(id), class=VALUES(class), flags=VALUES(flags), data=VALUES(data);
INSERT INTO `modules` (id, class, flags, data) VALUES('150', 'ProcessPageDelete', '3', '') ON DUPLICATE KEY UPDATE id=VALUES(id), class=VALUES(class), flags=VALUES(flags), data=VALUES(data);
INSERT INTO `modules` (id, class, flags, data) VALUES('151', 'MarkupSimpleNavigation', '0', '') ON DUPLICATE KEY UPDATE id=VALUES(id), class=VALUES(class), flags=VALUES(flags), data=VALUES(data);

INSERT INTO `pages` (id, parent_id, templates_id, name, status, modified, modified_users_id, created, created_users_id, sort) VALUES('1', '0', '1', 'home', '9', '2014-02-04 10:52:40', '41', '0000-00-00 00:00:00', '2', '0') ON DUPLICATE KEY UPDATE id=VALUES(id), parent_id=VALUES(parent_id), templates_id=VALUES(templates_id), name=VALUES(name), status=VALUES(status), modified=VALUES(modified), modified_users_id=VALUES(modified_users_id), created=VALUES(created), created_users_id=VALUES(created_users_id), sort=VALUES(sort);
...
INSERT INTO `pages` (id, parent_id, templates_id, name, status, modified, modified_users_id, created, created_users_id, sort) VALUES('1007', '3', '2', 'delete', '1', '2014-02-04 09:20:30', '41', '2014-02-04 09:20:30', '41', '8') ON DUPLICATE KEY UPDATE id=VALUES(id), parent_id=VALUES(parent_id), templates_id=VALUES(templates_id), name=VALUES(name), status=VALUES(status), modified=VALUES(modified), modified_users_id=VALUES(modified_users_id), created=VALUES(created), created_users_id=VALUES(created_users_id), sort=VALUES(sort);
...
INSERT INTO `session_login_throttle` (name, attempts, last_attempt) VALUES('phil', '1', '1391501643') ON DUPLICATE KEY UPDATE name=VALUES(name), attempts=VALUES(attempts), last_attempt=VALUES(last_attempt);
